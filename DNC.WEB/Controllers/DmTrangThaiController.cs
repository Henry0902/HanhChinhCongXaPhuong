...
{
    public class DmTrangThaiController : Controller
    {
        // GET: /DmDanToc/

        GenericRepository<DmTrangThai> _context = null;
        ...
        public ActionResult GetAll()
        {
            ...
            try
            {
                _context = new GenericRepository<DmTrangThai>();
                return Json(_context.GetAll().OrderBy(x => x.Id), JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
