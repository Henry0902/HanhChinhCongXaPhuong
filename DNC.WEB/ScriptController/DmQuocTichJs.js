...
myApp.controller("DmQuocTichJs",
    function ($location, $scope, $routeParams, $route, crudService, $http, $cookieStore) {
        ...
        //-------------------------------------------------------------------------------
        var lblmaQuocTich = document.getElementById("lblmaQuocTich");
        var lbltenQuocTich = document.getElementById("lbltenQuocTich");
        //-------------------------------------------------------------------------------
        ...
        $scope.getbyID = function (id) {
            crudService.get("/DmQuocTich/GetById?id=", id)
                .success(function (data) {
                    data.NgayTao = parseDate(data.NgayTao);
                    //$scope.QuocTich_id = data.QuocTich_id;
                    $scope.QuocTich = data;
        ...
        $scope.preCreate = function (data) {
            ...
            if (data == null) {
                $("#lblmaQuocTich").show();
                lblmaQuocTich.textContent = "Mã dự án không để trống";
                $("#lbltenQuocTich").show();
                lbltenQuocTich.textContent = "Tên dự án không để trống";
                return;
            }
        ...
        var validate = function (data) {
            //$('#lblmaQuocTich').hide();
            //$('#lbltenQuocTich').hide();
            //if (data.QuocTich_ma == null || data.QuocTich_ma == "") {
            //    $("#lblmaQuocTich").show();
            //    $("#lblmaQuocTich").textContent = "Mã dự án không để trống!";
            //    return false;
            //}
            //if (/[`~!@#$%^&*()_|+\=?;:'"<>\{\}\[\]\\\/]/gi.test(data.QuocTich_ma) == true) {
            //    $("#lblmaQuocTich").show();
            //    $("#lblmaQuocTich").textContent = "Mã dự án không chứa ký tự đặc biệt!";
            //    return false;
            //}
            //if (data.QuocTich_ten == null || data.QuocTich_ten == "") {
            //    $("#lbltenQuocTich").show();
            //    $("#lbltenQuocTich").textContent = "Tên dự án không để trống!";
            //    return false;
            //}
            //if (/[`~!@#$%^&*()_|+\=?;:'"<>\{\}\[\]\\\/]/gi.test(data.QuocTich_ten) == true) {
            //    $("#lbltenQuocTich").show();
            //    $("#lbltenQuocTich").textContent = "Tên dự án không chứa ký tự đặc biệt!";
            //    return false;
            //}
            return true;
        }
        ...
        $scope.create = function (data) {
            debugger
            crudService.create("/DmQuocTich/Create", data)
                .success(function (data) {
        ...
        $scope.update = function (data) {
            crudService.update("/DmQuocTich/Update", data)
                .success(function () {
        ...
        $scope.remove = function (id) {
            crudService.remove("/DmQuocTich/Delete", id)
                .success(function () {
