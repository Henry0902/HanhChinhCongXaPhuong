myApp.controller("BaoCaoTongHopKetQuaTiepCongDanJs",
function ($location, $scope, $routeParams, crudService, $http, $cookieStore, $filter) {
    ...
    var getDataReport1 = function () {
        ...
        return $http({
            url: "/BaoCao/BaoCao_TongHopKetQuaTiepCongDan",
            method: "GET",
            params: {
    ...
    $scope.Export_KetQuaTiepCongDan = function () {
        var dateSplit = "";
        var TuNgay = $scope.TuNgay;
        var DenNgay = $scope.DenNgay;
        if (TuNgay != null && TuNgay != "") {
        ...
        return $http({
            url: "/BaoCao/BC_KetQuaTiepCongDan",
            method: "GET",
            params: {
                IdDonVi: $scope.IdDonVi,
                TuNgay: TuNgay,
            ...
            document.getElementById('BC_KetQuaTiepCongDan').src = data;
