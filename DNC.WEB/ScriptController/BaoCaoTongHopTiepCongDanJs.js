myApp.controller("BaoCaoTongHopTiepCongDanJs",
function ($location, $scope, $routeParams, crudService, $http, $cookieStore, $filter) {
    ...
    var getDataReport1 = function () {
        ...
        return $http({
            ...
            params: {
                ...
                TuNgay: TuNgay,
                DenNgay: DenNgay,
                IdCapDonVi: crudService.getCookie("CapDonVi")
            }
        })
        .success(function (data) {
    ...
    $scope.Export_TongHopTiepCongDan = function () {
        var dateSplit = "";
        var TuNgay = $scope.TuNgay;
        var DenNgay = $scope.DenNgay;
        if (TuNgay != null && TuNgay != "") {
        ...
        return $http({
            url: "/BaoCao/BC_TongHopTiepCongDan",
            method: "GET",
            params: {
                IdDonVi: $scope.IdDonVi,
                TuNgay: TuNgay,
            ...
            document.getElementById('BC_TongHopTiepCongDan').src = data;
