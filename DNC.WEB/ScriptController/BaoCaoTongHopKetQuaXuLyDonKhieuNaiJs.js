myApp.controller("BaoCaoTongHopKetQuaXuLyDonKhieuNaiJs",
function ($location, $scope, $routeParams, crudService, $http, $cookieStore, $filter) {
    ...
    var getDataReport1 = function () {
        ...
        return $http({
            url: "/BaoCao/BaoCao_TongHopKetQuaXuLyDonThuKhieuNai",
            method: "GET",
            params: {
    ...
    //export BC_TongHopKetQuaXuLyDonKhieuNai
    $scope.Export_TongHopKetQuaXuLyDonKhieuNai = function () {
        var dateSplit = "";
        var TuNgay = $scope.TuNgay;
        var DenNgay = $scope.DenNgay;
        if (TuNgay != null && TuNgay != "") {
        ...
        return $http({
            url: "/BaoCao/BC_TongHopKetQuaXuLyDonKhieuNai",
            method: "GET",
            params: {
                IdDonVi: $scope.IdDonVi,
                TuNgay: TuNgay,
            ...
            document.getElementById('BC_TongHopKetQuaXuLyDonKhieuNai').src = data;
