myApp.controller("BaoCaoTongHopKetQuaXuLyDonKienNghiPhanAnhJs",
function ($location, $scope, $routeParams, crudService, $http, $cookieStore, $filter) {
    ...
    $scope.calculateTotals = function () {
        $scope.totals = {
            ...
            DaDuocGiaiQuyet: 0,
            ChuaDuocGiaiQuyet: 0,
            VuViecThuocThamQuyen: 0,
            DonChuyenDon: 0,
            DonDonDoc: 0,
            VuViecDaGiaiQuyet: 0,
            VuViecChuaGiaiQuyet: 0,
        };
    ...
    var getDataReport1 = function () {
        ...
        return $http({
            url: "/BaoCao/BaoCao_TongHopKetQuaXuLyDonThuKienNghiPhanAnh",
            method: "GET",
            params: {
    ...
    $scope.Export_TongHopKetQuaXuLyDonKienNghiPhanAnh = function () {
        var dateSplit = "";
        var TuNgay = $scope.TuNgay;
        var DenNgay = $scope.DenNgay;
        if (TuNgay != null && TuNgay != "") {
        ...
        return $http({
            url: "/BaoCao/BC_TongHopKetQuaXuLyDonKienNghiPhanAnh",
            method: "GET",
            params: {
                IdDonVi: $scope.IdDonVi,
                TuNgay: TuNgay,
            ...
            document.getElementById('BC_TongHopKetQuaXuLyDonKienNghiPhanAnh').src = data;
