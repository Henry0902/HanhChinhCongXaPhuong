...
myApp.controller("DonThuTiepNhanJs",
    function ($location, $scope, $routeParams, $route, crudService, fileUploadService, $http, $cookieStore) {
        ...
        //Hàm chuyển màu khi người dùng xem hồ sơ chuyển đơn
        $scope.markAsViewed = function (item) {
            item.IsViewed = true; // Đánh dấu hồ sơ đã được xem
            $scope.show(item); // Gọi hàm hiện chi tiết hồ sơ
        };
        ...
        $scope.PrintMau14 = function (Id) {
            return $http({
                url: "/VanBanMau/PrintMau14",
                method: "GET",
                params: {
                    Id: Id
                }
            }).success(function (data) {
                document.getElementById('PrintMau14').src = data;
        ...
        $scope.PrintMau21 = function (Id) {
            return $http({
                url: "/VanBanMau/PrintMau21",
                method: "GET",
                params: {
                    Id: Id
                }
            }).success(function (data) {
                document.getElementById('PrintMau21').src = data;
                $.notify("Xuất báo cáo thành công!", "success");
            }).error(function () {
                $.notify("Xuất báo cáo thất bại!", "error");
            });
        ...
        $scope.PrintMau22 = function (Id) {
            return $http({
                url: "/VanBanMau/PrintMau22",
                method: "GET",
                params: {
                    Id: Id
                }
            }).success(function (data) {
                document.getElementById('PrintMau22').src = data;
                $.notify("Xuất báo cáo thành công!", "success");
            }).error(function () {
                $.notify("Xuất báo cáo thất bại!", "error");
            });
        ...
        $scope.PrintMau23 = function (Id) {
            return $http({
                url: "/VanBanMau/PrintMau23",
                method: "GET",
                params: {
                    Id: Id
                }
            }).success(function (data) {
                document.getElementById('PrintMau23').src = data;
                $.notify("Xuất báo cáo thành công!", "success");
            }).error(function () {
                $.notify("Xuất báo cáo thất bại!", "error");
            });
        ...
        $scope.PrintMau30 = function (Id) {
            return $http({
                url: "/VanBanMau/PrintMau30",
                method: "GET",
                params: {
                    Id: Id
                }
            }).success(function (data) {
                document.getElementById('PrintMau30').src = data;
                $.notify("Xuất báo cáo thành công!", "success");
            }).error(function () {
                $.notify("Xuất báo cáo thất bại!", "error");
            });
        ...
        var createXuLyDonThu = function (data) {
            ...
            $scope.XuLyDonThu.IdTrangThai = 2;           
