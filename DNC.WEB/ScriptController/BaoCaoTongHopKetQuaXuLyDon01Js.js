myApp.controller("BaoCaoTongHopKetQuaXuLyDon01Js",
function ($location, $scope, $routeParams, crudService, $http, $cookieStore, $filter) {
    ...
    $scope.calculateTotals = function () {
        $scope.totals = {
            ...
            GiaiQuyetNhieuLan: 0,
            ChuaGiaiQuyet: 0,
            DonThuocThamQuyenKhieuNai: 0,
            DonThuocThamQuyenToCao: 0,
            DonThuocThamQuyenPhanAnh: 0,
            DonHuongDan: 0,
            DonChuyenDon: 0,
            DonDonDoc: 0,
            DonChuyenPhucDap: 0
    ...
    var getDataReport1 = function () {
        ...
        return $http({
            url: "/BaoCao/BaoCao_TongHopKetQuaXuLyDonThu01",
            method: "GET",
            params: {
    ...
    //Báo cáo tổng hợp kết quả xử lý đơn 01
    $scope.Export_BC_TongHopKetQuaXuLyDon01 = function () {
        var dateSplit = "";
        var TuNgay = $scope.TuNgay;
        var DenNgay = $scope.DenNgay;
        if (TuNgay != null && TuNgay != "") {
        ...
        return $http({
            url: "/BaoCao/BC_TongHopKetQuaXuLyDon01",
            method: "GET",
            params: {
                IdDonVi: $scope.IdDonVi,
                TuNgay: TuNgay,
            ...
            console.log(data);
            document.getElementById('BC_TongHopKetQuaXuLyDon01').src = data;
